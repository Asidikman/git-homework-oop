...
# Создадим лекторов и закрепим их к курсу
...
best_lecturer_3 = Lecturer('Irina', 'Lazareva')
best_lecturer_3.courses_attached += ['Python']

# Создадим проверяющих и закрепим их к курсу
cool_reviewer_1 = Reviewer('Man', 'Manov')
cool_reviewer_1.courses_attached += ['Python']
cool_reviewer_1.courses_attached += ['Java']

cool_reviewer_2 = Reviewer('Kirill', 'Kirillov')
cool_reviewer_2.courses_attached += ['Python']
cool_reviewer_2.courses_attached += ['Java']

# Создадим студентов и определим для них изучаемые и завершенные курсы
student_1 = Student('Artem', 'Petrov')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('David', 'Beckham')
student_2.courses_in_progress += ['Java']
student_2.finished_courses += ['Введение в программирование']

student_3 = Student('Victoriya', 'Beckham')
...
# Создадим функцию для подсчета средней оценки за домашние задания
...
# Создаем функцию для подсчета средней оценки за лекции всех лекторов
